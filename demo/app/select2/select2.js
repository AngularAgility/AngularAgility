angular
    ...
    .controller('select2example1', function($scope, select2States) {
    ...
    .controller('select2example2', function($scope, select2States) {
    ...
    .controller('select2example3', function($scope) {

    })

    .controller('select2example4', function($scope, select2States, $http) {
